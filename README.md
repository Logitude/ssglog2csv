...
5. Locate the `.html` file you just saved as well as the `ssglog2csv.py` file.

6. Drag and drop the `.html` file onto the `ssglog2csv.py` file. They don't need
to be in the same location.

7. Your new `.csv` file will be created next to your `.html` file.
